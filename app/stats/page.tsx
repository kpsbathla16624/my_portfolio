...
function StatsPage() {
  return (
    <div id='stats' className='z-50 px-10 relative text-white'>
      ...
      <div className='grid h-[200vh] lg:h-[150vh] grid-cols-10 gap-y-10 gap-x-4 grid-rows-12 lg:grid-rows-10  '>
        <div className='col-span-3 row-span-3 items-center justify-center flex flex-col  '>
          <QuestionCountGraph />
        </div>
        <div className=' col-span-5 lg:col-span-7 row-span-3  xl:col-span-5  items-center justify-center flex flex-col '>
          <LeetcodeTags/>
        </div>
        <div className='col-span-10 xl:col-span-6 row-span-3 items-center justify-center flex flex-col  bg-transparent'>
          <HeatMap codechefId='kps_bathla' codeforcesId='kpsbathla' leetcodeId='kamalpreet6198' />
        </div>
        <div className='col-span-10 2xl:col-span-6  row-span-2  border border-white space-y-2 flex flex-col w-min h-min p-2 rounded-xl'>
          <h1 className='text-2xl'>Github Contributions</h1>
          <GitHubCalendar   blockMargin={4}  username="kpsbathla16624" />
        </div>
